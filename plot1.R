...
#Now we creat a function which creates the first png

plot1 <- function() {
+     hist(datasubset$Global_active_power, main = paste("Global Active Power"), col="red", xlab="Global Active Power (kilowatts)")
